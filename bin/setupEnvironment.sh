...
install_desktop_environment(){
  ...
  package_install "xorg-server-xwayland grim slurp gtk3 qt5-wayland alacritty kitty qmk syncthing"
...
install_dev(){
  package_install "neovim npm code zed python-boto3 jdk21-openjdk docker docker-compose docker-buildx ruby jq rustup go tree-sitter-cli"
