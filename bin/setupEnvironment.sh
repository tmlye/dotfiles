...
install_desktop_environment(){
  ...
  package_install "zsh wayland sway swaylock swayidle swaybg wl-clipboard xorg-server-xwayland grim slurp gtk3 alacritty gnome-keyring libsecret brightnessctl waybar wofi"
